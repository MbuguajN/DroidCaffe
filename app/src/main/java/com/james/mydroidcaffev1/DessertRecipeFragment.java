...
public class DessertRecipeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //assign a layout for our recycler
    ...
    private void initializeData() {
        //get the data created in the resource file
        ...
        // create an array list for dessert recipes with title ,description and image
        ...
        //notify the adapter of change in new data set
